...
$(document).ready(function(){
	...
	function youtubeBackground() {
		...
		$(".hero #bg-youtube").attr('data-property', '{videoURL:option_hero_background_youtube_url,containment:".bg-video",autoPlay:true,mute:option_hero_background_youtube_mute,startAt: option_hero_background_youtube_startPoint,loop: option_hero_background_youtube_loop,opacity:1,stopMovieOnBlur:false,showControls:false}');
	...
	// YOUTUBE BACKGROUND FUNCTION
	function youtubeBackground_backup() {
		...
		$(".hero #bg-youtube").tubeplayer({
			initialVideo: option_hero_background_youtube_url,
